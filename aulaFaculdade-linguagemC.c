...
/*
    ...
    Aula de introducao a linguagem C, nessa aula foi feito o primeiro programa
    na linguagem C.
...
/*
    ...
    Aula de Variáveis e Tipos de Dados, nessa aula e explicado quais os tipos de variaveis e tipos dados.  
